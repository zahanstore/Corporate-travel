exports.handler = async function(event, context) {
  console.log('🚀 Airtable function - Using only writable fields');
  ...
  try {
    ...
    // Only use fields that are definitely writable (not linked records, not computed)
    const airtableData = {
      records: [
        {
          fields: {
            // Skip 'Customer' (linked record)
            // Skip 'Customer Email' (computed field)
